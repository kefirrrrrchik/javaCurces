...
//
//На основании разработанного класса Point создать набор объектов.
// Для созданного набора объектов реализовать следующие задачи:
//
//получить точку (объект) с наибольшим значением координаты x;
//создать новый поток чисел типа double. Каждое число является расстоянием от точки до начала координат.
// Полученный поток вывести на экран;
//создать новый поток объектов.
// В потоке должны быть точки (объекты), расстояние от которых до начала координат более 5;
